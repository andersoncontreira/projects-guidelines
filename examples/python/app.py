...
from application.flask import Flask
...
from application.services.v1.product_service import ProductService as ProductServiceV1
...
def index():
    ...
    See: Guidelines - RESTful - HATEOS - Root of the project
...
def alive():
    ...
    # pylint: disable=line-too-long
    See Guidelines - RESTful - Healthcheck
